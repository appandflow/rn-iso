...
// Shared shape for the tracked-path guard: whether git could answer at all
// (`known`), and a predicate over a relative path or path-segment prefix.
...
// branch when it has one (a detached-HEAD worktree has none).

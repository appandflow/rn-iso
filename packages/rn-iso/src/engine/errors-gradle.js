...
export function remedyFor(message) {
...
// terminal output.
export function extractGradleDiagnostics(text) {
...
export function capDiagnostics(diagnostics, limit = MAX_DIAGNOSTICS) {
...
function readWhatWentWrong(lines, start) {
  let i = start + 1;
...
function stripAaptPrefix(message) {

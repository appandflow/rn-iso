...
function undefinedSymbolMessage(symbol) {
...
function fileFromPrefix(prefix) {
...
function makeDiagnostic({ file = null, line = null, column = null, message }) {
...
export function extractXcodeDiagnostics(transcript) {
...
export function capDiagnostics(diagnostics, max = MAX_DIAGNOSTICS) {

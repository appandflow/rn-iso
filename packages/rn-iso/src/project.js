...
export function resolvePackageJson(projectRoot, name) {
  try {
...
export function isPackageResolvable(projectRoot, name) {
...
// what it is for.
export function looksLikeExpoConfig(appJson) {
...
function podfileUsesExpoModules(projectRoot) {
